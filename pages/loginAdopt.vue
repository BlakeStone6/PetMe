<template>
  <div class="container">
    ...
    <vs-tabs alignment="fixed">
      <vs-tab label="Sign up" @click="colorx = 'danger'">
        <div>
            ...
            <label>
              ...
              <vs-select v-model="habitation" placeholder="Choisir...">
                ...
                <vs-option
                  ...
                  value="maison avec jardin"
                >
                  Maison avec jardin
                </vs-option>
                <vs-option
                  label="Maison sans jardin"
                  value="maison sans jardin"
                >
                  Maison sans jardin
                </vs-option>
      ...
      <vs-tab @click="colorx = 'success'" label="Log in">
        <div>
